...
double compute_emat() {
    ...
    */
	...
	long int total = MEMORY_ACCESS_TIME*total_accesses;
	long int tlb = MEMORY_ACCESS_TIME*tlb_misses;
	long int pagefaults = DISK_ACCESS_TIME*count_pagefaults;  



	// return ave
	return (total+tlb+pagefaults)/total_accesses;;
}
